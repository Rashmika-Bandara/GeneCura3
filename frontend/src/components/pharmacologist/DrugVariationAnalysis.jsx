...
const DrugVariationAnalysis = () => {
  ...
  const medicines = [
    { medicine_id: 'MED001', name: 'Aspirin' },
    { medicine_id: 'MED002', name: 'Lisinopril' },
    { medicine_id: 'MED003', name: 'Metformin' }
  ]
  ...
  const auditHistory = [
    {
      ...
      actor_role: 'pharmacologist',
      actor_id: 'PHARM001',
      actor_name: 'Dr. Sarah Johnson',
      action: 'UPDATE',
      field: 'drug_interactions',
      before: 'Warfarin',
      after: 'Warfarin, Heparin',
      reason: 'Added new interaction based on recent study'
    },
    {
      id: 'AUDIT002',
      ...
      after: 'Salicylate sensitivity',
      reason: 'Updated based on clinical findings'
    },
    {
      id: 'AUDIT003',
      ...
      field: 'purpose',
      before: 'Pain relief',
      after: 'Pain relief and anti-inflammatory',
      reason: 'Clarified therapeutic indication'
    },
    {
      id: 'AUDIT004',
      timestamp: '2025-01-12 11:20:00',
      actor_role: 'pharmacologist',
      actor_id: 'PHARM001',
      actor_name: 'Dr. Sarah Johnson',
      action: 'CREATE',
      ...
      before: null,
      after: 'Initial medicine record created',
      reason: 'Added to formulary'
    }
  ]
  ...
  const selectedMedicineName = medicines.find(m => m.medicine_id === selectedMedicine)?.name || 'Unknown'
